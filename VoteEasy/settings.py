"""
Django settings for VoteEasy project.
...
SECRET_KEY = 'django-insecure-vac1doessrz+vayg9m(l5g(x7tw6i=n@@)hrudmv9a8jnf@iim'
...
WSGI_APPLICATION = 'VoteEasy.wsgi.application'
...
LOGIN_URL = '/login/' #take theme there
